...
struct DebugLatencyProbeCommand: Equatable {
    ...
    private static let environmentKey = "WISSH_DEBUG_LATENCY_PROBE"
    private static let delayEnvironmentKey = "WISSH_DEBUG_LATENCY_PROBE_DELAY_MS"
    ...
    var inputText: String {
        "printf __WISSH_%s__ LATENCY_\(probeID)\r"
    }
