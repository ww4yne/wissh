        ...
        controlGroup {
            HStack(spacing: isCompact ? 1 : 2) {
                GhosttyKeyboardChromeDockButton(
                    ...
                    accessibilityHint: "Open the Wissh library.",
...
enum GhosttyPhoneChromePalette {
    static let screenBackground = Color(white: 0.02)
    static let tray = screenBackground
    static let dock = Color(white: 0.04)
    static let groupSurface = Color(white: 0.05)
    static let pill = Color(white: 0.10)
    static let keySurface = Color(white: 0.09)
    static let keySurfacePressed = Color(white: 0.17)
...
private extension UIColor {
    static let ghosttyDefaultTerminalChromeAccent = UIColor.white
    static let catppuccinMochaTerminalChromeAccent = UIColor.white
    static let catppuccinLatteTerminalChromeAccent = UIColor.black
