...
enum SSHAuthResolverError: Error, Equatable, LocalizedError, Sendable {
    ...
    var errorDescription: String? {
        ...
        case .missingIdentity:
            "Wissh could not find the saved SSH identity for this server."
        case .missingCredential:
            "Wissh could not find the saved SSH credential for this identity."
        case .credentialKindMismatch:
            "Wissh found an SSH credential that does not match the selected identity type."
        }
    }
}
