...
final class DebugConnectionProfileSeederTests: XCTestCase {
    ...
    func testSeedPersistsConnectionProfileAndCredential() async throws {
        ...
        let seeded = try await DebugConnectionProfileSeeder.seedIfRequested(
            environment: [
                ...
                "WISSH_DEBUG_SERVER_PASSWORD": "debug-password",
    ...
    func testSeedPersistsPrivateKeyProfileAndCredential() async throws {
        ...
        let seeded = try await DebugConnectionProfileSeeder.seedIfRequested(
            environment: [
                ...
                "WISSH_DEBUG_SERVER_PORT": "22",
                "WISSH_DEBUG_SERVER_USERNAME": "demo",
                "WISSH_DEBUG_PRIVATE_KEY": Self.ed25519Key,
                "WISSH_DEBUG_PRIVATE_KEY_PASSPHRASE": "debug-passphrase",
                "WISSH_DEBUG_TMUX_SESSION": "base",
            ],
            profileRepository: repository,
            credentialStore: credentialStore
    ...
    func testSeedPersistsNoneIdentityWithoutCredential() async throws {
        ...
        let seeded = try await DebugConnectionProfileSeeder.seedIfRequested(
            environment: [
                "WISSH_DEBUG_SEED_CONNECTION": "1",
                "WISSH_DEBUG_SERVER_NAME": "Tailscale Server",
                "WISSH_DEBUG_SERVER_HOST": "100.64.0.1",
                "WISSH_DEBUG_SERVER_PORT": "22",
                "WISSH_DEBUG_SERVER_USERNAME": "demo",
                "WISSH_DEBUG_TMUX_SESSION": "base",
            ],
